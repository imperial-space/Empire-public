...
// public sealed partial class ClusterArrayGrenadeSystem : EntitySystem
// {
...
//     {
//         base.Initialize();
//         SubscribeLocalEvent<ClusterArrayGrenadeComponent, ComponentInit>(OnClugInit);
//         SubscribeLocalEvent<ClusterArrayGrenadeComponent, ComponentStartup>(OnClugStartup);
//         SubscribeLocalEvent<ClusterArrayGrenadeComponent, InteractUsingEvent>(OnClugUsing);
//         SubscribeLocalEvent<ClusterArrayGrenadeComponent, TriggerEvent>(OnClugTrigger);
//     }

//     private void OnClugInit(EntityUid uid, ClusterArrayGrenadeComponent component, ComponentInit args)
//     {
//         component.GrenadesContainer = _container.EnsureContainer<Container>(uid, "cluster-payload");
//     }

//     private void OnClugStartup(Entity<ClusterArrayGrenadeComponent> clug, ref ComponentStartup args)
//     {
//         var component = clug.Comp;
//         if (component.FillPrototype != null)
//         {
//             component.UnspawnedCount = Math.Max(0, component.FillPrototype.Count - component.GrenadesContainer.ContainedEntities.Count);
//             UpdateAppearance(clug);
//         }
//     }

//     private void OnClugUsing(Entity<ClusterArrayGrenadeComponent> clug, ref InteractUsingEvent args)
//     {
//         if (args.Handled)
//             return;
...
//         if (component.GrenadesContainer.ContainedEntities.Count >= component.FillPrototype.Count ||
...
//     private void OnClugTrigger(Entity<ClusterArrayGrenadeComponent> clug, ref TriggerEvent args)
//     {
//         var component = clug.Comp;
...
//         var query = EntityQueryEnumerator<ClusterArrayGrenadeComponent>();
...
//     private void ShootProjectile(EntityUid grenade, Angle angle, ClusterArrayGrenadeComponent clug, EntityUid clugUid)
//     {
...
//     private void ThrowGrenade(EntityUid grenade, Angle angle, ClusterArrayGrenadeComponent clug)
//     {
...
//     private bool TryGetGrenade(EntityUid clugUid, ClusterArrayGrenadeComponent component, out EntityUid grenade)
//     {
//         grenade = default;

//         if (component.UnspawnedCount > 0)
//         {
//             grenade = Spawn(component.FillPrototype[component.UnspawnedCount - 1], _transformSystem.GetMapCoordinates(clugUid));
...
//     private void UpdateAppearance(Entity<ClusterArrayGrenadeComponent> clug)
//     {
//         var component = clug.Comp;
