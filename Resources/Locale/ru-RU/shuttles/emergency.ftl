...
emergency-shuttle-extended = {" "}Время запуска было продлено в связи с неудобными обстоятельствами.

# Emergency shuttle console popup / announcement
emergency-shuttle-console-no-early-launches = Досрочный запуск отключён
emergency-shuttle-console-auth-left = Осталось {$remaining} допуска для досрочного запуска шаттла.
emergency-shuttle-console-auth-revoked = Авторизации на досрочный запуск шаттла отозваны, {$remaining} допусков необходимо.
