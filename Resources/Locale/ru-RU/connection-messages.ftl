...
whitelist-notes = Введите /admin remarks в чате. На данный момент у вас слишком много заметок администратора, чтобы присоединиться к этому серверу. Вы можете проверить свои заметки, введя /admin замечания в чате.
...
whitelist-fail-prefix = Не внесен в белый списо: {$msg}
