...
uplink-hardsuit-carp-desc = Выглядит как обычный костюм карпа, за исключением того, что полностью защищен от пространства и заставляет космических карпов думать, что вы один из них.
...
uplink-chameleon-projector-desc = Исчезните из поля зрения, создав голограмму предмета вокруг себя. Не используйте это для игры "Prop Hunt".
...
uplink-antimov-law-name = Плата законов
