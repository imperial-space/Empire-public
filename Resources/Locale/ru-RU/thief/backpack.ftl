...
thief-backpack-category-chameleon-description =
    В комплект входит полный набор снаряжения, оснащённого
    технологией хамелеона, позволяющего вам маскироваться
...
thief-backpack-category-tools-description =
    ...
    Включает два C4, мультитул, челюсти жизни, передатчик сигналов,
    инженерные очки, сварочный аппарат и пару изолированных перчаток.
...
thief-backpack-category-syndie-description =
    ...
    ограбили в прошлом. Включает в себя Емаг, глушитель связи,
    пачку крутых сигарет, несколько странных красных кристаллов,
    и бумажку с одним из кодовых слов Синдиката.
...
thief-backpack-category-sleeper-description =
    ...
    В комплект входит пара бутылочек ноктюрина,
...
thief-backpack-category-smuggler-description =
    ...
    Включает маяк фултона, десять фултонов, 3 дымовые гранаты
