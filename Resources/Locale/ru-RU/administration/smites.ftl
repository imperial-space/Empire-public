...
admin-smite-remove-hands-self = Вы не чувствуете свои руки!
...
admin-smite-super-bonk-description = Бросает их на каждый стол на Станции и за ее пределами.
admin-smite-super-bonk-lite-description= Бросает их на каждый стол на Станции и за ее пределами. Останавливается, когда цель мертва.
admin-smite-terminate-description = Создает роль призрака Терминатора с единственной целью - убить его.
...
admin-smite-set-alight-description = Заставить цель гореть.
admin-smite-monkeyify-description = Превратить цель в обезьяну.
admin-smite-lung-cancer-description = Рак лёгких III стадии, для настоящих любителей популярного шоу "Во все тяжкие".
...
admin-smite-pinball-description = Превращает цель в суперпрыгучий мяч, метая её об стены пока она не пролетит сквозь станцию в бездну.
...
admin-smite-become-mouse-description = Цель станет мышью. Пи!
