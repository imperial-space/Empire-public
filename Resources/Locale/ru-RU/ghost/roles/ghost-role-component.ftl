...
ghost-role-information-kobold-description = Будьте маленьким гремлином, кричите на людей и просите мяса!
...
ghost-role-information-rules-team-antagonist = Вы [color=red][bold]командный антагонист[/bold][/color]. Ваши намерения ясны и вредны для станции и ее экипажа.
                                               ...
                                               Вы можете помнить знания об игре в целом, например, как готовить, как использовать предметы и т. д.
