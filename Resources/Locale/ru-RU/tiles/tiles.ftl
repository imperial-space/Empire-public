...
tiles-brass-floor-filled = заполненная латунь
...
tiles-glass-floor-alt = необычный стеклянный пол
tiles-reinforced-glass-floor = бронестеклянный пол
tiles-reinforced-glass-floor-alt = необычный пол из бронестекла
...
tiles-steel-floor-checker-dark = стальная темная плитка в клетку
tiles-steel-floor-checker-light = стальная легкая клетчатая плитка
tiles-super-reinforced-floor = твёрдый армированный пол
tiles-web = плитка из паутины
tiles-chromite = хромит
tiles-astro-grass = астро трава
tiles-mowed-astro-grass = кошенная астро трава
tiles-jungle-astro-grass = джунглиевая астро трава
tiles-astro-ice = астро лёд
tiles-astro-snow = астро снег
tiles-wood-large = баольшое дерево
tiles-red-circuit-floor = красный контурный пол
...
tiles-metal-foam = пол из металлического пенопласта
tiles-lime-floor = известковый пол
tiles-lattice-train = железнодорожная решетка
tiles-grey-shuttle-floor = серый пол шаттла
tiles-black-shuttle-floor = черный пол челнока
