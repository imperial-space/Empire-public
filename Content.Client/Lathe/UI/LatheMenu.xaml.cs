...
public sealed partial class LatheMenu : DefaultWindow
{
    ...
    // Imperial PrinterDoc
    public event Action<bool>? OnUseCardIdCheckBoxChanged;
    ...
    public LatheMenu()
    {
        ...
        // Imperial PrinterDoc
        UseCardIdCheckBox.OnToggled += args =>
        {
            _useCardId = args.Pressed;
            OnUseCardIdCheckBoxChanged?.Invoke(args.Pressed);
        };
    ...
    /// Imperial PrinterDoc
    /// </summary>
    public void SetUseCardId(bool useCardId)
    {
